...
<div id = "Controll_Layer">
		...
		<div id = "background_gray" style="display:none">
			<a onclick ="close_div()" style="position:absolute; top:30px; right:30px"><img src ="img/close.png" width=20px height=20px style="cursor:pointer"/></a>
			<a onclick ="prev_div()" style="position:absolute; top:30px; left:30px"><img src ="img/next.png" width=11.48px height=20px style="cursor:pointer"/></a>
			...
			<div id = "second_layer" style="margin-top:140px; display:none;">
				<a onclick="expand_layer('stamp')"><img src = "/img/test3.png" width=160px style="cursor:pointer"></a>
				<a onclick="alert('서비스 준비중입니다!')"><img src = "/img/test6.png" width=160px style="cursor:pointer"></a>
			...
			<div id ="sign_Layer" style =" display:none">
				<div id = 'sign_background_white'>
					<div id = 'create_sign_layer' style="display:none;">
						<br><br><br>
						<input type ="text" id = "sign_name" value="" style="padding-left:15px; outline:none; width: 317px; height: 45px; border: 1px solid #707070; border-radius: 30px;"/>
				...
				document.getElementById("sign_download").addEventListener('click', event => event.target.href = canvas1.toDataURL());
			...
			<div id = 'stamp_Layer' style="display:none">
				<div id = 'stamp_background_white'>
					<br><br><br>
					<input type ="text" id = "name" value="" style="padding-left:15px; outline:none; width: 317px; height: 45px; border: 1px solid #707070; border-radius: 30px;"/>
					<input type ="button" id ="input_stamp_name" value="만들기" onclick='createStamp()' class ="button" style="width:99px; height:45px"/>
					<br><br><br><br>

					<canvas id="ctx1" width="120" height="120" style="margin-right:20px; border:1px solid black; display:none; cursor:pointer; cursor:hand" onclick="download_stamp(this)"></canvas>
					<canvas id="ctx2" width="120" height="120" style="border:1px solid black; display:none; cursor:pointer; cursor:hand" onclick="download_stamp(this)"></canvas>
					<canvas id="ctx3" width="120" height="120" style="margin-left:20px; border:1px solid black; display:none; cursor:pointer; cursor:hand" onclick="download_stamp(this)"></canvas>

					<a href="#" style="font-family: 'SongganggasaB'"></a>
					<a href="#" style="font-family: 'BBTreeCB'"></a>
					<a href="#" style="font-family: 'TTSeokbosangjeolB'"></a>
					<a href="" id = "ctx_down" style="display:none" download="stamp.png">stamp_download</a>
	...
	<div id = "Root" style="height:200%">
		...
		<div id = "controller_background_gray">
			<div id="title_background">
				<br>
				<input id="temp_title" type="text" name="title" placeholder="계약서 제목을 입력해주세요." maxlength="20" style="font: normal normal bold 25px/15px Noto Sans KR;font-size:30px;text-align: center;border:none;width:800px;border-right:0px; border-top:0px; border-left:0px; border-bottom:0px;" size="20">
			</div>
			<div id = "remote_2">

			<script>
			//remote에 scroll 기능 탑제
			var currentPosition = parseInt($("#remote_2").css("top"));
                $(window).scroll(function(){
				var position = $(window).scrollTop();
				if(position < 400)
				$("#remote_2").stop().animate({"top":position+currentPosition-100+"px"},800);
			});
			</script>
      ...
      function show_init(){
			...
			<input id="input" type = "image" src="/img/load.png" onclick="click_inputfile(this)" style="visibility:hidden"/><br>
            ...
            async function get_pdf_pages_num(){
				...
				<form action="/user/makeSign" method="post" id="submit_form" enctype="multipart/form-data">
        <div id="first_Sign_View" style="display:none;background-image:url(/img/참여자뒷배경.png);background-size:auto">
				<br>
				<div><img src="/img/참여자1.png" style="test-align:left" alt="참여자1"></div>
				<br>
				<div class="input_row"><input type="text" id="name1" placeholder="이름" style="background-image:url(/img/이름뒷배경.png);background-size:auto;border:none;border-right:0px; border-top:0px; border-left:0px; border-bottom:0px;" name="name1" size="20"></div>
				<div class="input_row"><input type="text" id="email1" style="background-image:url(/img/이메일뒷배경.png);background-size:auto;border:none;border-right:0px; border-top:0px; border-left:0px; border-bottom:0px;" placeholder="이메일" name="email1" size="20"></div>
				<br>
				</div>

          <div id="second_Sign_View" style="display:none;background-image:url(/img/참여자뒷배경.png);background-size:auto">
						<br>
		        <div><img src="/img/참여자2.png" alt="참여자2"></div>
						<br>
								<div class="input_row"><input type="text" id="name2" placeholder="이름" style="background-image:url(/img/이름뒷배경.png);background-size:auto;border:none;border-right:0px; border-top:0px; border-left:0px; border-bottom:0px;" name="name2" size="20"></div>
								<div class="input_row"><input type="text" id="email2" style="background-image:url(/img/이메일뒷배경.png);background-size:auto;border:none;border-right:0px; border-top:0px; border-left:0px; border-bottom:0px;" placeholder="이메일" name="email2" size="20"></div>
								<br>
					 </div>


          <div id="third_Sign_View" style="display:none;background-image:url(/img/참여자뒷배경.png);background-size:auto">
						<br>
		        <div><img src="/img/참여자3.png" alt="참여자3"></div>
						<br>
							<div class="input_row">	<input type="text" id="name3" style="background-image:url(/img/이름뒷배경.png);background-size:auto;background-size:auto;border:none;border-right:0px; border-top:0px; border-left:0px; border-bottom:0px;" placeholder="이름" name="name3" size="20"></div>
							<div class="input_row">	<input type="text" id="email3" style="background-image:url(/img/이메일뒷배경.png);background-size:auto;background-size:auto;border:none;border-right:0px; border-top:0px; border-left:0px; border-bottom:0px;" placeholder="이메일" name="email3" size="20"></div>
							<br>
			 			</div><br>
						...
						<br>
						<input id="btnout" type="button" onclick="location.href='/'" value="취소" class="button"  style="width=80px;height=40px;">
						<input id="btnin" type="button" value="승인 요청" onclick="sub_btnin()" class="button" style="width=80px;height=40px;">
						<input style="display:none;" multiple="multiple" type="file" name="uploadFile" id="inputfile" onchange="FiletoImg(this.files)" class="button">
	       ...
	       function drag_stamp(e) {
			...
			<div id="document_init" style="display:none">
				<div id ="init" style="display:none">
					<br><input type = "button" value ="도장 더하기" onclick="add_img_layer('stamp')" class="button"/><br>
					<br><input type = "button" value ="서명 더하기" onclick="add_img_layer('sign')" class="button"/><br>
					<script type="text/javascript">
					//이미지 레이어 추가하기
                    ...
                    <br>
					<input id="savebutton" type = "button" value ="변경사항 저장" onclick="saveImg()" class="button"/><br>
					<script type="text/javascript">
					...
					<br><input id="initbutton" type = "button" value ="전체 초기화" onclick="window.location.reload()" class="button"/><br>

					<br>
					<!-- <input id = "first_download" type ="button" class ="button" value ="다운로드(갑)" onclick="download_document('first')" style="visibility:hidden"><br> -->
					<input id = "first_download" type ="button" class ="button" value ="다운로드" onclick="download_document('first')" style="visibility:hidden"><br>
					<br>
					<input id = "second_download" type ="button" class ="button" value ="다운로드(을)" onclick="download_document('second')" style="visibility:hidden"><br>
					<br>
					<input id = "third_download" type ="button" class ="button" value ="다운로드(병)" onclick="download_document('third')" style="visibility:hidden"><br>
					<script>
					//도장을 받아서 그려줌
