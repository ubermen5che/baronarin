	...
	<div id = "Controll_Layer" style="display: flex;justify-content: space-between;align-items: center;">
		...
		<div id = "background_gray" style="display:none">
			...
			<div id = "first_layer" style="display:inline-block; position:absolute; top:50%; left:50%; transform:translate(-50%,-50%)">
				<a href="DocumentPage.html"><img src = "/img/test1.png" width=160px style="cursor:pointer"></a>
	...
	<div id = "Root" style="height:200%">
		...
		<div id = "controller_background_gray">
			<div id="title_background">
				...
				<p name="title" style="font: normal normal bold 25px/15px Noto Sans KR;font-size:30px;text-align: center;">
				<input type="button" value="${orig_Name} 다운로드" style="font: normal normal bold 25px/15px Noto Sans KR;font-size:30px;text-align: center;" onclick="down_sign()">
				<form action="/user/signedDownload" method="post" id="sub_download">
			...
			<input id="input" type = "image" src="/img/load.png" onclick="click_inputfile(this)" style="display:none;"/><br>
			
			
						<input type="hidden" id="imgName" value="${file_serName}" style="display:none;">
			<!--  <img src="<spring:url value = '/image/${file_serName}'/>" name="imagename"> -->
						<input style="display:none;" multiple="multiple" onchange="FiletoImg(this.files)" type="file" id="inputfile"class="button" >
			<script type="text/javascript">
        ...
        <div id="first_Sign_View" style="display:none;text-align:center;background-image:url(/img/서명확인뒷배경.png);margin-right:20px;background-repeat:no-repeat;background-position:center center;">
				...
				<span  id="per1_no">승인 여부 :      &nbsp;  &nbsp;&nbsp;&nbsp;&nbsp;<span style="color: red">미승인</span></span>
          ...
          <div id="second_Sign_View" style="display:none;text-align:center;background-image:url(/img/서명확인뒷배경.png);margin-right:20px;background-repeat:no-repeat;background-position:center center;">
						...
						<div style="font: normal normal bold 15px/17px Noto Sans KR;padding-top:8px;padding-bottom:10px;">

						<p>이름 :    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ${person2_name}<p>
						
						<span style="display:none" id="per2_ok">승인 여부 :   &nbsp;  &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;<span style="color: blue">승인</span></span>
						<span  id="per2_no">승인 여부 :      &nbsp;  &nbsp;&nbsp;&nbsp;&nbsp;<span style="color: red">미승인</span></span>
          ...
          <div id="third_Sign_View" style="display:none;text-align:center;background-image:url(/img/서명확인뒷배경.png);margin-right:20px;background-repeat:no-repeat;background-position:center center;">
						...
						<span  id="per3_no">승인 여부 :      &nbsp;  &nbsp;&nbsp;&nbsp;&nbsp;<span style="color: red">미승인</span></span>
					...
					window.onload = function()
					{
						...
						if(a1=='1')
							...
							document.getElementById('per1_no').style.display= "none";
							}
						
						if(a2=='1')
						{
						document.getElementById('per2_ok').style.display = "block";
						document.getElementById('per2_no').style.display= "none";
						}
						if(a3=='1')
						{
						document.getElementById('per3_ok').style.display = "block";
						document.getElementById('per3_no').style.display= "none";
						}
...
document.getElementById("download_div").style.visibility = "hidden";
	...
	window.onload = function()
	{
		var name2 = $('#query_per2_name').val();
		var name3 = $('#query_per3_name').val();
		if(name2=='')
		{
			document.getElementById('second_Sign_View').style.display = "none";
			}
		if(name3=='')
			{
			document.getElementById('third_Sign_View').style.display = "none";
			}
	}
