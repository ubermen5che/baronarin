...
<div style="position: absolute; display: flex; justify-content: space-between; align-items: center;top: 356px;left: 761px">
	...
	<div style="position: absolute;top: 448px;left: 761px">
...
<script>
	function submit_form()
	{
		...
		$('#emailValue').val($('#checkName').val());//사용자 이메일
