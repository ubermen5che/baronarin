...
<head>
    <meta charset="utf-8">
    <meta name ="google-signin-client_id" content="903769449867-ajtlf0jn345jd3njdoucctd1f8ts73hb.apps.googleusercontent.com">
...
<div data-layer="040e6dbb-5eca-455a-a767-ad8b636aaa94" class="webHome">
    ...
    <div data-layer="b9310510-a28c-488f-862b-b2178a41653a" class="x966" id="GgCustomLogin"></div>
    <div data-layer="3c0eb85a-5772-4214-9c18-598bca1c7f1d" class="x965"></div>
    <div data-layer="03dffb51-2ce1-41e8-949e-3cfe69417308" class="x959" id="naver_id_login"></div>
...
<script>
    ...
    {
        console.log(profile.Yt);
        console.log(profile.uT);
        $.ajax({
            url: "/login"
            ,data : {email:profile.Yt,password:profile.uT}
            ,method: 'POST'
        })
            .done(function(e)
            {
...
<script>
    var naver_id_login = new naver_id_login("SheQVMyDKSx0PaRWhsDG", "http://localhost:8090");
